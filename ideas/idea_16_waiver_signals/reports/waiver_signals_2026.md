...
**Archive coverage:** 71% of batters, 83% of pitchers had pre-pickup game log data  
...
| 2 | `hr_per_game_14d` | 0.467 | ↑ higher | ≥ 0.167 | 0.72 | 0.75 | 0.73 | 0.234 | 0.000 |
| 3 | `hr_per_game_7d` | 0.466 | ↑ higher | ≥ 0.143 | 0.74 | 0.74 | 0.74 | 0.200 | 0.000 |
| 4 | `batting_slot_mode_7d` | -0.412 | ↓ lower | ≤ 7.000 | 0.68 | 0.96 | 0.79 | 5.000 | 7.000 |
| 5 | `r_per_game_14d` | 0.402 | ↑ higher | ≥ 0.250 | 0.59 | 0.96 | 0.73 | 0.604 | 0.333 |
| 6 | `r_per_game_7d` | 0.356 | ↑ higher | ≥ 0.167 | 0.63 | 0.96 | 0.76 | 0.600 | 0.400 |
| 7 | `ownership_slope_14d` | 0.333 | ↑ higher | ≥ 1.670 | 1.00 | 0.67 | 0.80 | 1.670 | 0.592 |
| 8 | `pct_change_mean_14d` | 0.300 | ↑ higher | ≥ 3.503 | 1.00 | 0.50 | 0.67 | 2.107 | 0.482 |
| 9 | `games_played_7d` | 0.296 | ↑ higher | ≥ 2.000 | 0.62 | 1.00 | 0.77 | 5.000 | 5.000 |
| 10 | `ab_per_game_14d` | 0.284 | ↑ higher | ≥ 3.000 | 0.69 | 1.00 | 0.81 | 3.523 | 3.333 |
| 11 | `ops_7d` | 0.275 | ↑ higher | ≥ 0.293 | 0.62 | 1.00 | 0.77 | 1.006 | 0.940 |
| 12 | `games_played_14d` | 0.257 | ↑ higher | ≥ 3.000 | 0.57 | 0.96 | 0.72 | 11.000 | 8.000 |
| 13 | `pct_change_mean_7d` | 0.250 | ↑ higher | ≥ 3.503 | 1.00 | 0.50 | 0.67 | 2.107 | 0.844 |
| 14 | `ops_14d` | 0.235 | ↑ higher | ≥ 0.543 | 0.61 | 0.96 | 0.74 | 0.925 | 0.804 |
| 15 | `top_order_rate_7d` | 0.176 | ↑ higher | ≥ 0.000 | 0.59 | 1.00 | 0.74 | 0.000 | 0.000 |
...
- **`hr_per_game_14d` ≥ 0.167**  (r = 0.467, precision = 0.72, recall = 0.75, F1 = 0.73)
- **`hr_per_game_7d` ≥ 0.143**  (r = 0.466, precision = 0.74, recall = 0.74, F1 = 0.74)
- **`batting_slot_mode_7d` ≤ 7.000**  (r = -0.412, precision = 0.68, recall = 0.96, F1 = 0.79)
- **`r_per_game_14d` ≥ 0.250**  (r = 0.402, precision = 0.59, recall = 0.96, F1 = 0.73)
- **`r_per_game_7d` ≥ 0.167**  (r = 0.356, precision = 0.63, recall = 0.96, F1 = 0.76)
- **`ownership_slope_14d` ≥ 1.670**  (r = 0.333, precision = 1.00, recall = 0.67, F1 = 0.80)
- **`pct_change_mean_14d` ≥ 3.503**  (r = 0.300, precision = 1.00, recall = 0.50, F1 = 0.67)
...
|--------|------|----------|---|----------------|
| Jordan Walker | Midnight Muncy's | 2026-03-30 | 19.84 | `hr_per_game_14d` (0.33 >= 0.17), `hr_per_game_7d` (0.33 >= 0.14), `batting_slot_mode_7d` (6.00 <= 7.00), `r_per_game_14d` (2.00 >= 0.25), `r_per_game_7d` (2.00 >= 0.17) |
...
| Liam Hicks | All Rise | 2026-04-02 | 11.11 | `hr_per_game_14d` (0.60 >= 0.17), `hr_per_game_7d` (0.60 >= 0.14), `batting_slot_mode_7d` (4.00 <= 7.00), `r_per_game_14d` (1.20 >= 0.25), `r_per_game_7d` (1.20 >= 0.17) |
| Bryson Stott | Midnight Muncy's | 2026-03-23 | 10.20 | — |
| Brandon Marsh | Datalickmyballs | 2026-04-15 | 9.12 | `hr_per_game_14d` (0.18 >= 0.17), `hr_per_game_7d` (0.17 >= 0.14), `batting_slot_mode_7d` (4.00 <= 7.00), `r_per_game_14d` (0.64 >= 0.25), `r_per_game_7d` (0.67 >= 0.17) |
| Wilyer Abreu | Dingers Only | 2026-03-26 | 8.16 | — |
| Casey Schmitt | Welcome to the JUNGle | 2026-05-05 | 7.62 | `hr_per_game_14d` (0.27 >= 0.17), `hr_per_game_7d` (0.17 >= 0.14), `batting_slot_mode_7d` (4.00 <= 7.00), `r_per_game_14d` (0.36 >= 0.25), `r_per_game_7d` (0.17 >= 0.17) |
| Zack Gelof | All Rise | 2026-05-09 | 7.53 | `hr_per_game_14d` (0.18 >= 0.17), `hr_per_game_7d` (0.40 >= 0.14), `batting_slot_mode_7d` (5.00 <= 7.00), `r_per_game_14d` (0.64 >= 0.25), `r_per_game_7d` (1.20 >= 0.17) |
...
| Ivan Herrera | This Schlitt is Bazzanas | 2026-04-27 | 6.43 | `hr_per_game_14d` (0.33 >= 0.17), `hr_per_game_7d` (0.33 >= 0.14), `batting_slot_mode_7d` (2.00 <= 7.00), `r_per_game_14d` (0.58 >= 0.25), `r_per_game_7d` (0.33 >= 0.17) |
| Dillon Dingler | This Schlitt is Bazzanas | 2026-04-04 | 6.43 | `hr_per_game_14d` (0.33 >= 0.17), `hr_per_game_7d` (0.25 >= 0.14), `batting_slot_mode_7d` (5.00 <= 7.00), `r_per_game_14d` (0.50 >= 0.25), `r_per_game_7d` (0.50 >= 0.17) |
| Mickey Moniak | Skubal Snacks | 2026-04-12 | 6.14 | `hr_per_game_14d` (0.56 >= 0.17), `hr_per_game_7d` (0.71 >= 0.14), `batting_slot_mode_7d` (3.00 <= 7.00), `r_per_game_14d` (0.67 >= 0.25), `r_per_game_7d` (0.71 >= 0.17) |
...
| Nolan Arenado | Big Dumpers | 2026-04-29 | 4.39 | `hr_per_game_14d` (0.20 >= 0.17), `hr_per_game_7d` (0.20 >= 0.14), `batting_slot_mode_7d` (7.00 <= 7.00), `r_per_game_14d` (0.80 >= 0.25), `r_per_game_7d` (1.20 >= 0.17) |
...
|---------|--------|--------|--------|--------|-------------|
| `hr_per_game_14d` | 0.467 | ↑ | 0.663 | ↑ | ✓ |
| `hr_per_game_7d` | 0.466 | ↑ | 0.405 | ↑ | ✓ |
| `r_per_game_14d` | 0.402 | ↑ | 0.745 | ↑ | ✓ |
| `r_per_game_7d` | 0.356 | ↑ | 0.668 | ↑ | ✓ |
| `games_played_7d` | 0.296 | ↑ | 0.754 | ↑ | ✓ |
| `ab_per_game_14d` | 0.284 | ↑ | 0.319 | ↑ | ✓ |
| `ops_7d` | 0.275 | ↑ | 0.435 | ↑ | ✓ |
| `games_played_14d` | 0.257 | ↑ | 0.716 | ↑ | ✓ |
| `ops_14d` | 0.235 | ↑ | 0.447 | ↑ | ✓ |
| `ab_per_game_7d` | 0.130 | ↑ | 0.283 | ↑ | ✓ |
| `sb_per_game_14d` | 0.091 | ↑ | 0.400 | ↑ | ✓ |
| `sb_per_game_7d` | 0.081 | ↑ | 0.258 | ↑ | ✓ |
...
|---------|--------|--------|--------|--------|-------------|
| `era_14d` | -0.402 | ↓ | -0.641 | ↓ | ✓ |
| `appearances_7d` | 0.259 | ↑ | 0.360 | ↑ | ✓ |
| `whip_14d` | -0.234 | ↓ | -0.551 | ↓ | ✓ |
| `svhd_per_app_14d` | 0.226 | ↑ | 0.437 | ↑ | ✓ |
| `appearances_14d` | 0.201 | ↑ | 0.464 | ↑ | ✓ |
| `svhd_per_app_7d` | 0.163 | ↑ | 0.450 | ↑ | ✓ |
| `era_7d` | -0.120 | ↓ | -0.485 | ↓ | ✓ |
| `whip_7d` | 0.048 | ↑ | -0.336 | ↓ | ✗ |
| `k9_14d` | 0.045 | ↑ | 0.530 | ↑ | ✓ |
| `k9_7d` | 0.045 | ↑ | 0.535 | ↑ | ✓ |
...
- **Name coverage:** Players without a `player_map.csv` entry have no archive features.
